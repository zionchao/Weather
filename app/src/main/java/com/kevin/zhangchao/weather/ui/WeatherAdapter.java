...
import static com.kevin.zhangchao.weather.utils.SharedPreferenceUtil.getInstance;
...
class WeatherAdapter extends RecyclerView.Adapter{
    ...
    private final Weather mWeatherData;
        ...
        protected void bind(Weather weather) {
            try {
                ...
                ImageLoader.load(itemView.getContext(),
                        getInstance().getInt(weather.now.cond.txt, R.mipmap.none),
                        weatherIcon);
            } catch (Exception e) {
